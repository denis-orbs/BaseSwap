...
export async function transformRoutesToTrade(
  ...
  const approveInfo = await getApproveInfo(account, currencyIn as Token, amount, usdCostPerGas)
...
export function currencyAddressForSwapQuote(currency: Token): string {

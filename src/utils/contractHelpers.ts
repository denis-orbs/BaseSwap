...
import tokenLocker from 'config/abi/locker.json'
...
export const getTokenLocker = (signer?: Signer | Provider) => {
  return getContract(tokenLocker, getTokenLockerAddress(), signer) as any
}
